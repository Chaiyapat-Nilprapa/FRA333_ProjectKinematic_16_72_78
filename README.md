...
- กำหนดตำเเหน่ง **(x,y,z)** ที่ต้องการก่อนเข้าบล็อก **IK_Simulink** เเละกด **RUN** ระบบ
![Input](Picture/Input.png)

- สามารถอ่านค่าเอาท์พุตที่ออกมาได้จาก **Display** ซึ่งจะเเสดงข้อมูล(ตำเเหน่ง ความเร็ว ความเร่ง เเละเเรงบิดที่เกิดขึ้น) เพื่อเปรียบเทียบระหว่าง **"ผลที่คำนวนได้"** กับ **"ค่าที่เกิดขึ้นจริง"**
...
ระบบไดนามิกของระบบถูกคำนวณโดยใช้ **Lagrangian Mechanics (L)** ซึ่งเป็นผลต่างระหว่างพลังงานจลน์ (K) และพลังงานศักย์ (P): 
...
พลังงานจลน์รวมทั้งการเคลื่อนที่เชิงเส้นและการหมุนของแต่ละลิงก์ในระบบ:

**K = 1/2 ∑(m_I * v_I^T * v_I + w_I^T * I_I * w_I)**


โดยที่:

- **m_I**: มวลของลิงก์ที่ I  
- **v_I**: ความเร็วเชิงเส้นของจุดศูนย์กลางมวลของลิงก์ I  
- **w_I**: ความเร็วเชิงมุมของลิงก์ I  
- **I_I**: เมทริกซ์โมเมนต์ความเฉื่อยของลิงก์ I  

---

**พลังงานศักย์ (P)**

พลังงานศักย์คำนวณจากตำแหน่งของจุดศูนย์กลางมวลภายใต้แรงโน้มถ่วง:

**P = ∑(m_I * G * h_I)**

โดยที่:

- **G**: เวกเตอร์แรงโน้มถ่วง  
- **h_I**: ความสูงของจุดศูนย์กลางมวลของลิงก์ I  

---

**Euler-Lagrange Equation**

สมการออยเลอร์-ลากรังจ์ใช้เพื่อหาสมการไดนามิกและแรงบิดที่ต้องการในข้อต่อ:

**τ_I = d/dt (∂L/∂Q̇_I) - ∂L/∂Q_I**

โดยที่:

- **τ_I**: แรงบิดที่กระทำกับข้อต่อ I  
- **Q_I**: มุมของข้อต่อ I  
- **Q̇_I**: ความเร็วเชิงมุมของข้อต่อ I  
- **Q̈_I**: ความเร่งเชิงมุมของข้อต่อ I  
---
